...
def object_to_dict(obj: object) -> dict:
    if isinstance(obj, dict):
    ...
    elif hasattr(obj, "__dict__"):  # If object has __dict__, process it
        ...
        return obj  # Base case: return value directly if not an object



def append_to_jsonl(file_path: str, records: List[Dict[str, Any]]) -> None:
    """Append a list of JSON records to a JSONL file."""
